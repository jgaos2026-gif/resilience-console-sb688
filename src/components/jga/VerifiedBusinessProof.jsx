...
const PROOF_DOCS = [
  {
    ...
    fileNumber: "IL SOS — ON FILE",
    verifiable: "cyberdriveillinois.com · Auth # on file",
  ...
  },
  {
    ...
    date: "July 9, 2025",
    details: "EIN [REDACTED] assigned to Jays Graphic Arts / JPS Professional Services, % John E Arenz I, Sole Mbr — Mendota, IL. Form SS-4, Notice CP575G.",
    fileNumber: "IRS EIN — ON FILE",
  ...
  },
  {
    ...
    details: "Jays Graphic Arts DBA Jps Professional Services. Location: Mendota, La Salle County. Sales and use taxes and fees. Cert # and Loc. Code on file.",
    fileNumber: "IDOR CERT — ON FILE",
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="rounded-xl border p-3 grid grid-cols-2 sm:grid-cols-4 gap-3 text-center text-[9px]"
            ...
            {[
              ...
              { label: "EIN",             value: "ON FILE ✓",      color: GOLD },
